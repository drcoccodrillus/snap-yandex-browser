...
snap connect yandex-browser:alsa
snap connect yandex-browser:audio-record
snap connect yandex-browser:bluez
...
snap connect yandex-browser:system-packages-doc
snap connect yandex-browser:u2f-devices
snap connect yandex-browser:hardware-observe
snap connect yandex-browser:network-control
snap connect yandex-browser:network-manager
snap connect yandex-browser:network-manager-observe
snap connect yandex-browser:network-observe
